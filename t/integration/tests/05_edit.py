...
class EditTests(TestCase):
    ...
    def setUp(self):
        ...
        try:
            self.admin.create(profile=self.test_profile_alpine, name=CONTAINER_NAME)
    ...
    def test_02_edit_viewers(self):
        self.admin.update(CONTAINER_NAME, viewers=self.test_username_viewer)
    ...
    def test_03_edit_developers(self):
        self.admin.update(CONTAINER_NAME, developers=self.test_username_dev1)

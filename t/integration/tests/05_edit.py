...
class EditTests(TestCase):
    ...
    def test_05_viewer_cannot_edit(self):
        ...
        self.assert_api_error(
            self.viewer.update, CONTAINER_NAME, description='viewer edit attempt'
        )

    def test_06_non_owner_developer_can_edit_allowed_fields(self):
        """After testdev1 is added as developer, they can update description and viewers."""
        self.admin.update(CONTAINER_NAME, developers='testdev1')
        self.dev1.update(CONTAINER_NAME, description='edited by dev1')
        data = self.admin.get_container(CONTAINER_NAME)
        meta = data.get('meta') or {}
        desc = meta.get('description') or data.get('description')
    ...
    def test_07_dev2_cannot_edit_when_not_developer(self):
        ...
        self.admin.update(CONTAINER_NAME, developers='testdev1')
        self.assert_api_error(
            self.dev2.update, CONTAINER_NAME, description='dev2 edit attempt'
        )

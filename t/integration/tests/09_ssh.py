...
def _build_proxy_command(uid_cookie_name, uid_cookie_value, wss_url):
    """
    ...
    In local/harness mode, wss_url is wss://localhost:<port> and the ssh config's
    Host line provides the hostname via %n (for TLS SNI).
    In remote mode, wss_url is wss://<host> and %n resolves to the same host.
    """
